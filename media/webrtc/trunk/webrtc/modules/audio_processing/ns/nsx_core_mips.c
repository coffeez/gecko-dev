...
void WebRtcNsx_AnalysisUpdate_mips(NoiseSuppressionFixedC* inst,
  ...
  __asm __volatile(
   ...
   "1:                                                     \n\t"
    ...
    "sw                %[r6],      12(%[outBuf])           \n\t"
#endif
    PTR_ADDIU         "%[window],  %[window],    16        \n\t"
    PTR_ADDIU         "%[anaBuf],  %[anaBuf],    16        \n\t"
    PTR_ADDIU         "%[outBuf],  %[outBuf],    16        \n\t"
    "b                 1b                                  \n\t"
    " addiu            %[iters],   %[iters],     -1        \n\t"
   "2:                                                     \n\t"
    "andi              %[after],   %[anaLen],    7         \n\t"
   "3:                                                     \n\t"
    ...
    "lh                %[r1],      0(%[anaBuf])            \n\t"
    "mul               %[r0],      %[r0],        %[r1]     \n\t"
    PTR_ADDIU         "%[window],  %[window],    2         \n\t"
    PTR_ADDIU         "%[anaBuf],  %[anaBuf],    2         \n\t"
    PTR_ADDIU         "%[outBuf],  %[outBuf],    2         \n\t"
    "shra_r.w          %[r0],      %[r0],        14        \n\t"
    "sh                %[r0],      -2(%[outBuf])           \n\t"
    "b                 3b                                  \n\t"
    " addiu            %[after],   %[after],     -1        \n\t"
  ...
  __asm  __volatile(
   ...
   "1:                                                      \n\t"
    ...
    "mul            %[r4],      %[r4],          %[r5]       \n\t"
    "mul            %[r6],      %[r6],          %[r7]       \n\t"
    PTR_ADDIU      "%[window],  %[window],      8           \n\t"
    PTR_ADDIU      "%[anaBuf],  %[anaBuf],      8           \n\t"
    "addiu          %[r0],      %[r0],          0x2000      \n\t"
    "addiu          %[r2],      %[r2],          0x2000      \n\t"
    "addiu          %[r4],      %[r4],          0x2000      \n\t"
    "addiu          %[r6],      %[r6],          0x2000      \n\t"
...
void WebRtcNsx_SynthesisUpdate_mips(NoiseSuppressionFixedC* inst,
  ...
  __asm __volatile(
   ...
   "1:                                                      \n\t"
    ...
    "sh         %[r6],      6(%[out])                       \n\t"
    PTR_ADDIU  "%[window],  %[window],      8               \n\t"
    PTR_ADDIU  "%[real],    %[real],        8               \n\t"
    PTR_ADDIU  "%[synthBuf],%[synthBuf],    8               \n\t"
    PTR_ADDIU  "%[out],     %[out],         8               \n\t"
    "b          1b                                          \n\t"
    " addiu     %[iters],   %[iters],       -1              \n\t"
   "2:                                                      \n\t"
...
void WebRtcNsx_PrepareSpectrum_mips(NoiseSuppressionFixedC* inst,
  ...
  __asm __volatile (
    ...
    PTR_ADDIU  "%[real],            %[real],              2          \n\t"
    PTR_ADDIU  "%[imag],            %[imag],              2          \n\t"
    PTR_ADDIU  "%[noiseSupFilter],  %[noiseSupFilter],    2          \n\t"
    PTR_ADDIU  "%[freq_buf_f],      %[freq_buf_f],        4          \n\t"
   "1:                                                               \n\t"
    "lh         %[tmp_1],           0(%[noiseSupFilter])             \n\t"
    "lh         %[tmp_2],           0(%[real])                       \n\t"
    "lh         %[tmp_3],           0(%[imag])                       \n\t"
    ...
    "sra        %[tmp_5],           %[tmp_5],             14         \n\t"
    "sra        %[tmp_6],           %[tmp_6],             14         \n\t"
    PTR_ADDIU  "%[noiseSupFilter],  %[noiseSupFilter],    4          \n\t"
    "sh         %[tmp_2],           0(%[real])                       \n\t"
    ...
    "negu       %[tmp_6],           %[tmp_6]                         \n\t"
    PTR_ADDIU  "%[freq_buf_s],      %[freq_buf_s],        -8         \n\t"
    PTR_ADDIU  "%[real],            %[real],              4          \n\t"
    PTR_ADDIU  "%[imag],            %[imag],              4          \n\t"
    "sh         %[tmp_2],           0(%[freq_buf_f])                 \n\t"
    "sh         %[tmp_3],           2(%[freq_buf_f])                 \n\t"
    "sh         %[tmp_5],           4(%[freq_buf_f])                 \n\t"
    "sh         %[tmp_6],           6(%[freq_buf_f])                 \n\t"
    "blt        %[loop_count],      %[loop_size],         1b         \n\t"
    PTR_ADDIU  "%[freq_buf_f],      %[freq_buf_f],        8          \n\t"
    //last two samples:
    "lh         %[tmp_1],           0(%[noiseSupFilter])             \n\t"
    "lh         %[tmp_2],           0(%[real])                       \n\t"
    "lh         %[tmp_3],           0(%[imag])                       \n\t"
